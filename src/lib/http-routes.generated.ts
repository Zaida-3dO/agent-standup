...
export const HTTP_ROUTES: readonly HttpRoute[] = [
  ...
  { path: "/api/crew/wait", methods: ["GET"] },
  ...
  { path: "/api/interventions/{id}/level", methods: ["PUT", "DELETE"] },
  { path: "/api/interventions/{id}/score", methods: ["POST"] },
  { path: "/api/interventions/scores", methods: ["GET"] },
  { path: "/api/interventions/settings", methods: ["GET"] },
  { path: "/api/items", methods: ["GET", "POST"] },
  { path: "/api/items/{id}", methods: ["GET", "PATCH", "DELETE"] },
  { path: "/api/items/{id}/artifacts", methods: ["GET", "POST"] },
  { path: "/api/items/{id}/blocked-on-tool", methods: ["POST"] },
  { path: "/api/items/{id}/body", methods: ["GET"] },
