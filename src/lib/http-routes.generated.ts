...
export const HTTP_ROUTES: readonly HttpRoute[] = [
  ...
  { path: "/api/areas/{id}", methods: ["GET", "PATCH"] },
  ...
  { path: "/api/people/{id}", methods: ["PATCH"] },
  ...
  { path: "/api/repos/{id}", methods: ["GET", "PATCH"] },
